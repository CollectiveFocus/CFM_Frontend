...
const pageContent = {
  content: [
    ...
    {
      img: {
        src: '/paragraph/pamphlet/about/Moda.webp',
      ...
      body: [
        'Community fridges are used by many people everyday, oftentimes working class families, the elderly, and unhoused people looking for an extra food source. A common value is respect for the autonomy of each refrigerator and those who depend on them. The thousands of fridges in action represent a variety of identities and ethos that are as unique as the neighborhoods that run them. Refrigerators are independent and decentralized. They are operated by local businesses, mutual aid groups, neighbors, and organizations.
',
      ],
    },
    {
...
',
    ...
    {
      img: {
        src: '/paragraph/pamphlet/about/table.webp',

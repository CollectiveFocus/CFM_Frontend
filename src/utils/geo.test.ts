...
describe('deltaInMeters', () => {
  it('calculates zero distance for identical coordinates', () => {
    const origin: [number, number] = [40.7128, -74.006]; // New York City
    const destination: [number, number] = [40.7128, -74.006];
  ...
  it('calculates small distance accurately', () => {
    const pointA: [number, number] = [51.5007, -0.1246]; // London Eye
    const pointB: [number, number] = [51.5014, -0.1419]; // Buckingham Palace

...
export function AboutIcon(props: SvgIconProps): React.ReactElement {
  return (
...
export function ContactUsIcon(props: SvgIconProps): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
...
export function FridgeAddIcon(props: SvgIconProps): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
      <path
...
export function FridgeFindIcon(props: SvgIconProps): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
      <path
        d="M7.726 8.843c0-.446.362-.808.809-.808h5.23c.446 0 .807.362.807.808v9.13a.808.808 0 0 1-.808.809h-5.23a.808.808 0 0 1-.808-.808z"
...
export function GetInvolvedIcon(props: SvgIconProps): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
      <g stroke="#222">
        <path
...
export function GuidelineIcon(props: SvgIconProps): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
      <rect
        width="8.93"
...
function svgUrlPin(
  ...
  return (
    'data:image/svg+xml,' +
    encodeURIComponent(
      `<svg fill="${color}" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision">
...
export function svgUrlPinLocation(color: string, decoration: string): string {
  return svgUrlPin(color, svgFaceSmile, decoration);
}

export function svgUrlPinNoReport(): string {
  return svgUrlPin('#d3d3d3', svgFaceSmile, '', 'stroke-dasharray="4,2"');
}

export function svgUrlPinNotAtLocation(): string {
  return svgUrlPin('#d3d3d3', svgFaceX);
}

export function svgUrlPinGhost(): string {
  return (
    'data:image/svg+xml,' +
    encodeURIComponent(
      `<svg fill="#e3f2fd99" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision">
 ...
 */
export function MapLegendConditionDirtyIcon(
  props: SvgIconProps
): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
...
export function MapLegendConditionOutOfOrderIcon(
  props: SvgIconProps
): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
...
export function MapLegendPinLocationIcon(
  props: SvgIconProps
): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
...
export function MapLegendPinNotAtLocationIcon(
  props: SvgIconProps
): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
...
export function MapLegendPinNoReportIcon(
  props: SvgIconProps
): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
...
export function MapLegendPinGhostIcon(props: SvgIconProps): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
      <path
        stroke="#222"
...
export function StatusIcon(props: SvgIconProps): React.ReactElement {
  return (
    <SvgIcon viewBox="0 0 24 24" {...props}>
...
// --- Profile / reward action icons ---

type SizeIconProps = { size?: number };

export function PointsIcon({ size = 20 }: SizeIconProps): React.ReactElement {
  return (
...
export function ReportedIcon({ size = 20 }: SizeIconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 100 100" width={size} height={size}>
      <rect
        x="10"
...
export function CleanedIcon({ size = 20 }: SizeIconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 100 100" width={size} height={size}>
      <circle
        cx="50"
...
export function FilledIcon({ size = 20 }: SizeIconProps): React.ReactElement {
  return (
    <svg viewBox="0 0 100 100" width={size} height={size}>
      <path

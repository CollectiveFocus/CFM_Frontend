...
The following creates git aliases for the bash shell. Type `code ~/.bashrc` to open the bash shell configuration file and add these lines to it.
...
alias gr-d=' git rebase origin/dev'
